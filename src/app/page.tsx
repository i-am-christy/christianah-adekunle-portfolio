          ...
          <div className="hero-copy">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Button
                ...
                variant="outline"
                className="h-11 border-burgundy px-7 text-burgundy hover:bg-burgundy hover:text-white"
              >
                Resume
              </Button>
            </div>
          </div>
          <Portrait priority className="portrait-in" />
        </div>
      </section>

      <section className="border-b border-border">
        <div className="mx-auto grid max-w-6xl items-start gap-10 px-6 py-16 lg:grid-cols-[1.05fr_0.95fr] lg:px-8">
          <Reveal>
          ...
          <div className="mt-10 divide-y divide-border border border-border">
            {expertise.map((item) => (
              <Link
                ...
                className="expertise-row grid gap-2 px-6 py-6 hover:bg-charcoal sm:grid-cols-[220px_1fr]"
              >
